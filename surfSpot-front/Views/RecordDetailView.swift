...
struct RecordDetailView: View {
    @Binding var record: MyRecord
    var body: some View {
        VStack {
            AsyncImage(
                url: URL(string: record.photo_url),
                content: { image in
                    image.resizable()
